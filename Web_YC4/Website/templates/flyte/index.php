...
<title>Flyte Shop - Bán những sản phẩm chất lượng nhất với giá thành hợp lý nhất</title>  
...
<script>
  ...
  ga('create', 'UA-76645019-1', 'auto');
  ga('send', 'pageview');

</script>
  
  	<meta name="google-site-verification" content="pI_8tnxJmRbRQWSLQ29pBNPqxAJKeAZIRzpqeoUpYq4" />
	<meta name="alexaVerifyID" content="Q-LAhmsrkU4Tpr_zCmk7pl3YOeI"/>
	...
	<section class="content">
		...
		<?php endif; ?>		  
				  ...
				  <?php if($this->countModules('content-middle')): ?>
				 	 <div class="content-middle span9"><!-- content-middle section starts here -->
