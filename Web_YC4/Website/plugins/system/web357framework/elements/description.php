	...
	{		
		...
		switch ($extension_name):
			...
			case "fix404errorlinks":
				...
				if (JRequest::getVar('option') == 'com_installer' && JRequest::getVar('view') == 'install'):
		...
		$html .= (!empty($installation_instructions)) ? '<p>'.$installation_instructions.'</p>' : '';
		
		// begin row
		$html .= '<div class="row-fluid w357 '.JRequest::getVar('option').'">';
