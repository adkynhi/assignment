        ...
        <form action="" method="get" enctype="multipart/form-data">
            <?php
                if($_GET["action"]=="update"){
                    echo "<input type='hidden' name='action' value='updateProcess'/>";
                }else if($_GET["action"]=="delete"){
                    echo "<input type='hidden' name='action' value='deleteProcess'/>";
                }else{
                    echo "<input type='hidden' name='action' value='insertProcess'/>";
                }                
            ?>
            <table style="text-align:left">
                ...
                <tr>
                    <td>Hình ảnh</td>
                    <td><input class="cart_btn" type="file" name="img" value="<?php if(isset($id)){echo $set[2];} ?>"/></td>
                </tr>
                <tr>
                    <td colspan="2">
