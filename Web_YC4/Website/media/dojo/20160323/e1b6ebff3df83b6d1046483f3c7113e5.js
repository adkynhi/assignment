        ...
        (function(){
            djConfig = {
              modulePaths: {
                "dojo": "/joomla/plugins/system/dojoloader/dojo/1.6.1/dojo",
                "dijit": "/joomla/plugins/system/dojoloader/dojo/1.6.1/dijit",
                "dojox": "/joomla/plugins/system/dojoloader/dojo/1.6.1/dojox"
              }
...
dojo.addOnLoad(function(){
      var offlajnParams = new OfflajnParams({
        joomla17 : 1,
        moduleName : "mod_fancy_tagcloud"
      });
    

      new OfflajnList({
        name: "jformparamsmoduleparametersTabmenutypemenutype",
        options: [{"value":"joomla","text":"Joomla"}],
        selectedIndex: 0,
        json: "",
        width: 0,
        height: 0,
        ...
        new TypeConfigurator({
          selectorId: "jformparamsmoduleparametersTabmenutypemenutype",
          typeParams: {"default":"","joomla":"226776f356d7ecf58b60bab12a05d38f"},
          typeScripts: {"default":""},
          joomfish: 0,
          control: "TYPE"
        });
      ...
      var theme = new ThemeConfigurator({
        ...
        themeSelector: null,
        themeParams: {"default":"","simple":"8dbdda48fb8748d6746f1965824e966a"},
      ...
      new OfflajnOnOff({
        id: "jformparamsadvancedtabcaching",
        mode: "",
        imgs: ""
      }); 
