...
class PostTasks {
	...
	function publish_link($post = array(), $topic = array()){
		...
		if(!empty($post['Post'])):
			...
			<a title="<?php echo l_('CHRONOFORUMS_PUBLISH'); ?>" class="btn btn-success gcoreTooltip" href="<?php echo r_("index.php?ext=chronoforums&cont=posts&act=publish&p=".$post['Post']['id']."&t=".$post['Post']['topic_id']."&f=".$post['Post']['forum_id']); ?>"><i class="fa fa-plus-circle fa-lg"></i></a>
			<?php endif; ?>
			<?php
		endif;
	}
	...
	function unpublish_link($post = array(), $topic = array()){
		...
		if(!empty($post['Post'])):
			?>
			<?php if(\GCore\Libs\Authorize::authorized('\GCore\Extensions\Chronoforums\Chronoforums', 'modify_topics')): ?>
			<a title="<?php echo l_('CHRONOFORUMS_UNPUBLISH'); ?>" class="btn btn-danger gcoreTooltip" href="<?php echo r_("index.php?ext=chronoforums&cont=posts&act=unpublish&p=".$post['Post']['id']."&t=".$post['Post']['topic_id']."&f=".$post['Post']['forum_id']); ?>"><i class="fa fa-minus-circle fa-lg"></i></a>
			<?php endif; ?>
			<?php
		endif;
	}
